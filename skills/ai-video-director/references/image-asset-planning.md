...
核心规则：剧本完成后，不要立刻写视频提示词。先提炼全片关键资产，优先生成定妆照、场景图、道具图和关键帧，再决定每个镜头用文生视频、图生视频、首帧视频、首尾帧视频还是多参考图视频。
...
6. 镜头首帧和尾帧
   - 用于需要精准动作起止、转场、变形、开合、爆炸前后、角色入画出画的镜头。
